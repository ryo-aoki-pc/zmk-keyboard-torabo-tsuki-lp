...
| 操作 | (outer)<br>`&none` | Q<br>`&kp Q` | W<br>`&kp W` | E<br>`&kp E` | R<br>`&kp R` | T<br>`&kp T` | Y<br>`&kp Y` | U<br>`&kp U` | I<br>`&kp I` | O<br>`&kp O` | P<br>`&kp P` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | Q 入力 | W 入力 | E 入力 | R 入力 | T 入力 | Y 入力 | U 入力 | I 入力 | O 入力 | P 入力 | 何もしない |
| ダブルタップ | 何もしない | Q 入力 × 2 | W 入力 × 2 | E 入力 × 2 | R 入力 × 2 | T 入力 × 2 | Y 入力 × 2 | U 入力 × 2 | I 入力 × 2 | O 入力 × 2 | P 入力 × 2 | 何もしない |
| Shift+ | 何もしない | Shift + Q（OS で合成） | Shift + W（OS で合成） | Shift + E（OS で合成） | Shift + R（OS で合成） | Shift + T（OS で合成） | Shift + Y（OS で合成） | Shift + U（OS で合成） | Shift + I（OS で合成） | Shift + O（OS で合成） | Shift + P（OS で合成） | 何もしない |
| Ctrl+ | 何もしない | Ctrl + Q（OS で合成） | Ctrl + W（OS で合成） | Ctrl + E（OS で合成） | Ctrl + R（OS で合成） | Ctrl + T（OS で合成） | Ctrl + Y（OS で合成） | Ctrl + U（OS で合成） | Ctrl + I（OS で合成） | Ctrl + O（OS で合成） | Ctrl + P（OS で合成） | 何もしない |

#### Row 2 (home row)

| 操作 | (outer)<br>`&none` | A<br>`&mt LEFT_CONTROL A` | S<br>`&kp S` | D<br>`&kp D` | F<br>`&kp F` | G<br>`&kp G` | (center L)<br>`&none` | (center R)<br>`&none` | H<br>`&kp H` | J<br>`&kp J` | K<br>`&kp K` | L<br>`&kp L` | MINUS<br>`&mt RCTRL MINUS` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | A 入力（タップ） | S 入力 | D 入力 | F 入力 | G 入力 | 何もしない | 何もしない | H 入力 | J 入力 | K 入力 | L 入力 | MINUS 入力（タップ） | 何もしない |
| ダブルタップ | 何もしない | A 入力 × 2 | S 入力 × 2 | D 入力 × 2 | F 入力 × 2 | G 入力 × 2 | 何もしない | 何もしない | H 入力 × 2 | J 入力 × 2 | K 入力 × 2 | L 入力 × 2 | MINUS 入力 × 2 | 何もしない |
| Shift+ | 何もしない | Shift + A（または Left Ctrl ホールドで修飾） | Shift + S（OS で合成） | Shift + D（OS で合成） | Shift + F（OS で合成） | Shift + G（OS で合成） | 何もしない | 何もしない | Shift + H（OS で合成） | Shift + J（OS で合成） | Shift + K（OS で合成） | Shift + L（OS で合成） | Shift + MINUS（または Right Ctrl ホールドで修飾） | 何もしない |
| Ctrl+ | 何もしない | Ctrl + A | Ctrl + S（OS で合成） | Ctrl + D（OS で合成） | Ctrl + F（OS で合成） | Ctrl + G（OS で合成） | 何もしない | 何もしない | Ctrl + H（OS で合成） | Ctrl + J（OS で合成） | Ctrl + K（OS で合成） | Ctrl + L（OS で合成） | Ctrl + MINUS | 何もしない |

#### Row 3 (Z row)

| 操作 | (outer)<br>`&none` | Z<br>`&mt LEFT_SHIFT Z` | X<br>`&kp X` | C<br>`&kp C` | V<br>`&kp V` | B<br>`&kp B` | (center L)<br>`&mo 7` | (center R)<br>`&mo 7` | N<br>`&kp N` | M<br>`&kp M` | COMMA<br>`&kp COMMA` | PERIOD<br>`&kp PERIOD` | SLASH<br>`&mt RIGHT_SHIFT SLASH` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | Z 入力（タップ） | X 入力 | C 入力 | V 入力 | B 入力 | レイヤー 7 を momentary（押下中のみ）有効化 | レイヤー 7 を momentary（押下中のみ）有効化 | N 入力 | M 入力 | COMMA 入力 | PERIOD 入力 | SLASH 入力（タップ） | 何もしない |
| ダブルタップ | 何もしない | Z 入力 × 2 | X 入力 × 2 | C 入力 × 2 | V 入力 × 2 | B 入力 × 2 | レイヤー 7 を momentary（押下中のみ）有効化 | レイヤー 7 を momentary（押下中のみ）有効化 | N 入力 × 2 | M 入力 × 2 | COMMA 入力 × 2 | PERIOD 入力 × 2 | SLASH 入力 × 2 | 何もしない |
| Shift+ | 何もしない | Shift + Z（または Left Shift ホールドで修飾） | Shift + X（OS で合成） | Shift + C（OS で合成） | Shift + V（OS で合成） | Shift + B（OS で合成） | レイヤー 7 を momentary（押下中のみ）有効化 | レイヤー 7 を momentary（押下中のみ）有効化 | Shift + N（OS で合成） | Shift + M（OS で合成） | Shift + COMMA（OS で合成） | Shift + PERIOD（OS で合成） | Shift + SLASH（または Right Shift ホールドで修飾） | 何もしない |
| Ctrl+ | 何もしない | Ctrl + Z | Ctrl + X（OS で合成） | Ctrl + C（OS で合成） | Ctrl + V（OS で合成） | Ctrl + B（OS で合成） | レイヤー 7 を momentary（押下中のみ）有効化 | レイヤー 7 を momentary（押下中のみ）有効化 | Ctrl + N（OS で合成） | Ctrl + M（OS で合成） | Ctrl + COMMA（OS で合成） | Ctrl + PERIOD（OS で合成） | Ctrl + SLASH | 何もしない |

#### Row 4 (thumb)

| 操作 | (outer)<br>`&none` | mo6 (outer)<br>`&mo 6` | LEFT_WIN<br>`&kp LEFT_WIN` | LEFT_ALT<br>`&kp LEFT_ALT` | lt2 SPACE<br>`&lt 2 SPACE` | lt2 SPACE<br>`&lt 2 SPACE` | (mo1 center)<br>`&mo 1` | (mo2 center)<br>`&mo 2` | lt1 ENTER<br>`&lt 1 ENTER` | (none)<br>`&none` | (none)<br>`&none` | mo6<br>`&mo 6` | mo6 (outer)<br>`&mo 6` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | レイヤー 6 を momentary（押下中のみ）有効化 | Left Win 入力 | Left Alt 入力 | SPACE 入力（タップ） | SPACE 入力（タップ） | レイヤー 1 を momentary（押下中のみ）有効化 | レイヤー 2 を momentary（押下中のみ）有効化 | ENTER 入力（タップ） | 何もしない | 何もしない | レイヤー 6 を momentary（押下中のみ）有効化 | レイヤー 6 を momentary（押下中のみ）有効化 | 何もしない |
| ダブルタップ | 何もしない | レイヤー 6 を momentary（押下中のみ）有効化 | Left Win 入力 × 2 | Left Alt 入力 × 2 | SPACE 入力 × 2 | SPACE 入力 × 2 | レイヤー 1 を momentary（押下中のみ）有効化 | レイヤー 2 を momentary（押下中のみ）有効化 | ENTER 入力 × 2 | 何もしない | 何もしない | レイヤー 6 を momentary（押下中のみ）有効化 | レイヤー 6 を momentary（押下中のみ）有効化 | 何もしない |
| Shift+ | 何もしない | レイヤー 6 を momentary（押下中のみ）有効化 | Shift + Left Win（OS で合成） | Shift + Left Alt（OS で合成） | Shift + SPACE（ホールドでレイヤー 2） | Shift + SPACE（ホールドでレイヤー 2） | レイヤー 1 を momentary（押下中のみ）有効化 | レイヤー 2 を momentary（押下中のみ）有効化 | Shift + ENTER（ホールドでレイヤー 1） | 何もしない | 何もしない | レイヤー 6 を momentary（押下中のみ）有効化 | レイヤー 6 を momentary（押下中のみ）有効化 | 何もしない |
| Ctrl+ | 何もしない | レイヤー 6 を momentary（押下中のみ）有効化 | Ctrl + Left Win（OS で合成） | Ctrl + Left Alt（OS で合成） | Ctrl + SPACE（ホールドでレイヤー 2） | Ctrl + SPACE（ホールドでレイヤー 2） | レイヤー 1 を momentary（押下中のみ）有効化 | レイヤー 2 を momentary（押下中のみ）有効化 | Ctrl + ENTER（ホールドでレイヤー 1） | 何もしない | 何もしない | レイヤー 6 を momentary（押下中のみ）有効化 | レイヤー 6 を momentary（押下中のみ）有効化 | 何もしない |
...
| 操作 | (outer)<br>`&none` | Q<br>`&kp N1` | W<br>`&kp N2` | E<br>`&kp N3` | R<br>`&kp N4` | T<br>`&kp N5` | Y<br>`&kp N6` | U<br>`&kp N7` | I<br>`&kp N8` | O<br>`&kp N9` | P<br>`&kp N0` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | N1 入力 | N2 入力 | N3 入力 | N4 入力 | N5 入力 | N6 入力 | N7 入力 | N8 入力 | N9 入力 | N0 入力 | 何もしない |
| ダブルタップ | 何もしない | N1 入力 × 2 | N2 入力 × 2 | N3 入力 × 2 | N4 入力 × 2 | N5 入力 × 2 | N6 入力 × 2 | N7 入力 × 2 | N8 入力 × 2 | N9 入力 × 2 | N0 入力 × 2 | 何もしない |
| Shift+ | 何もしない | Shift + N1（OS で合成） | Shift + N2（OS で合成） | Shift + N3（OS で合成） | Shift + N4（OS で合成） | Shift + N5（OS で合成） | Shift + N6（OS で合成） | Shift + N7（OS で合成） | Shift + N8（OS で合成） | Shift + N9（OS で合成） | Shift + N0（OS で合成） | 何もしない |
| Ctrl+ | 何もしない | Ctrl + N1（OS で合成） | Ctrl + N2（OS で合成） | Ctrl + N3（OS で合成） | Ctrl + N4（OS で合成） | Ctrl + N5（OS で合成） | Ctrl + N6（OS で合成） | Ctrl + N7（OS で合成） | Ctrl + N8（OS で合成） | Ctrl + N9（OS で合成） | Ctrl + N0（OS で合成） | 何もしない |

#### Row 2 (home row)

| 操作 | (outer)<br>`&none` | A<br>`&mt LCTRL TAB` | S<br>`&kp GRAVE` | D<br>`&kp LEFT_BRACKET` | F<br>`&kp RIGHT_BRACKET` | G<br>`&kp DELETE` | (center L)<br>`&none` | (center R)<br>`&none` | H<br>`&kp BACKSPACE` | J<br>`&kp SEMICOLON` | K<br>`&kp SINGLE_QUOTE` | L<br>`&kp BACKSLASH` | MINUS<br>`&trans` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | TAB 入力（タップ） | GRAVE 入力 | LEFT_BRACKET 入力 | RIGHT_BRACKET 入力 | DELETE 入力 | 何もしない | 何もしない | BACKSPACE 入力 | SEMICOLON 入力 | SINGLE_QUOTE 入力 | BACKSLASH 入力 | フォールスルー | 何もしない |
| ダブルタップ | 何もしない | TAB 入力 × 2 | GRAVE 入力 × 2 | LEFT_BRACKET 入力 × 2 | RIGHT_BRACKET 入力 × 2 | DELETE 入力 × 2 | 何もしない | 何もしない | BACKSPACE 入力 × 2 | SEMICOLON 入力 × 2 | SINGLE_QUOTE 入力 × 2 | BACKSLASH 入力 × 2 | フォールスルー | 何もしない |
| Shift+ | 何もしない | Shift + TAB（または Left Ctrl ホールドで修飾） | Shift + GRAVE（OS で合成） | Shift + LEFT_BRACKET（OS で合成） | Shift + RIGHT_BRACKET（OS で合成） | Shift + DELETE（OS で合成） | 何もしない | 何もしない | Shift + BACKSPACE（OS で合成） | Shift + SEMICOLON（OS で合成） | Shift + SINGLE_QUOTE（OS で合成） | Shift + BACKSLASH（OS で合成） | フォールスルー | 何もしない |
| Ctrl+ | 何もしない | Ctrl + TAB | Ctrl + GRAVE（OS で合成） | Ctrl + LEFT_BRACKET（OS で合成） | Ctrl + RIGHT_BRACKET（OS で合成） | Ctrl + DELETE（OS で合成） | 何もしない | 何もしない | Ctrl + BACKSPACE（OS で合成） | Ctrl + SEMICOLON（OS で合成） | Ctrl + SINGLE_QUOTE（OS で合成） | Ctrl + BACKSLASH（OS で合成） | フォールスルー | 何もしない |

#### Row 3 (Z row)

| 操作 | (outer)<br>`&none` | Z<br>`&mt LEFT_SHIFT ESCAPE` | X<br>`&none` | C<br>`&none` | V<br>`&none` | B<br>`&none` | (center L)<br>`&none` | (center R)<br>`&none` | N<br>`&none` | M<br>`&kp EQUAL` | COMMA<br>`&trans` | PERIOD<br>`&trans` | SLASH<br>`&trans` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | ESC 入力（タップ） | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | EQUAL 入力 | フォールスルー | フォールスルー | フォールスルー | 何もしない |
| ダブルタップ | 何もしない | ESC 入力 × 2 | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | EQUAL 入力 × 2 | フォールスルー | フォールスルー | フォールスルー | 何もしない |
| Shift+ | 何もしない | Shift + ESC（または Left Shift ホールドで修飾） | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | Shift + EQUAL（OS で合成） | フォールスルー | フォールスルー | フォールスルー | 何もしない |
| Ctrl+ | 何もしない | Ctrl + ESC | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | Ctrl + EQUAL（OS で合成） | フォールスルー | フォールスルー | フォールスルー | 何もしない |

#### Row 4 (thumb)

| 操作 | (outer)<br>`&none` | mo6 (outer)<br>`&none` | LEFT_WIN<br>`&trans` | LEFT_ALT<br>`&trans` | lt2 SPACE<br>`&lt 3 SPACE` | lt2 SPACE<br>`&lt 3 SPACE` | (mo1 center)<br>`&none` | (mo2 center)<br>`&mo 3` | lt1 ENTER<br>`&none` | (none)<br>`&none` | (none)<br>`&none` | mo6<br>`&trans` | mo6 (outer)<br>`&none` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | 何もしない | フォールスルー | フォールスルー | SPACE 入力（タップ） | SPACE 入力（タップ） | 何もしない | レイヤー 3 を momentary（押下中のみ）有効化 | 何もしない | 何もしない | 何もしない | フォールスルー | 何もしない | 何もしない |
| ダブルタップ | 何もしない | 何もしない | フォールスルー | フォールスルー | SPACE 入力 × 2 | SPACE 入力 × 2 | 何もしない | レイヤー 3 を momentary（押下中のみ）有効化 | 何もしない | 何もしない | 何もしない | フォールスルー | 何もしない | 何もしない |
| Shift+ | 何もしない | 何もしない | フォールスルー | フォールスルー | Shift + SPACE（ホールドでレイヤー 3） | Shift + SPACE（ホールドでレイヤー 3） | 何もしない | レイヤー 3 を momentary（押下中のみ）有効化 | 何もしない | 何もしない | 何もしない | フォールスルー | 何もしない | 何もしない |
| Ctrl+ | 何もしない | 何もしない | フォールスルー | フォールスルー | Ctrl + SPACE（ホールドでレイヤー 3） | Ctrl + SPACE（ホールドでレイヤー 3） | 何もしない | レイヤー 3 を momentary（押下中のみ）有効化 | 何もしない | 何もしない | 何もしない | フォールスルー | 何もしない | 何もしない |
...
| 操作 | (outer)<br>`&none` | Q<br>`&none` | W<br>`&none` | E<br>`&none` | R<br>`&none` | T<br>`&none` | Y<br>`&none` | U<br>`&none` | I<br>`&none` | O<br>`&none` | P<br>`&none` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない |
| ダブルタップ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない |
| Shift+ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない |
...
| 操作 | (outer)<br>`&none` | A<br>`&none` | S<br>`&none` | D<br>`&none` | F<br>`&none` | G<br>`&none` | (center L)<br>`&none` | (center R)<br>`&none` | H<br>`&none` | J<br>`&none` | K<br>`&mo 5` | L<br>`&none` | MINUS<br>`&none` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | レイヤー 5 を momentary（押下中のみ）有効化 | 何もしない | 何もしない | 何もしない |
| ダブルタップ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | レイヤー 5 を momentary（押下中のみ）有効化 | 何もしない | 何もしない | 何もしない |
| Shift+ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | レイヤー 5 を momentary（押下中のみ）有効化 | 何もしない | 何もしない | 何もしない |
| Ctrl+ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | レイヤー 5 を momentary（押下中のみ）有効化 | 何もしない | 何もしない | 何もしない |

#### Row 3 (Z row)

| 操作 | (outer)<br>`&none` | Z<br>`&none` | X<br>`&none` | C<br>`&none` | V<br>`&none` | B<br>`&none` | (center L)<br>`&none` | (center R)<br>`&none` | N<br>`&none` | M<br>`&none` | COMMA<br>`&none` | PERIOD<br>`&none` | SLASH<br>`&none` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
| 操作 | (outer)<br>`&none` | A<br>`&none` | S<br>`&none` | D<br>`&none` | F<br>`&none` | G<br>`&none` | (center L)<br>`&none` | (center R)<br>`&none` | H<br>`&none` | J<br>`&mkp MB1` | K<br>`&none` | L<br>`&mkp MB2` | MINUS<br>`&none` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 未対応: &mkp MB1 | 何もしない | 未対応: &mkp MB2 | 何もしない | 何もしない |
| ダブルタップ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 未対応: &mkp MB1 | 何もしない | 未対応: &mkp MB2 | 何もしない | 何もしない |
| Shift+ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 未対応: &mkp MB1 | 何もしない | 未対応: &mkp MB2 | 何もしない | 何もしない |
| Ctrl+ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 未対応: &mkp MB1 | 何もしない | 未対応: &mkp MB2 | 何もしない | 何もしない |

#### Row 3 (Z row)

| 操作 | (outer)<br>`&none` | Z<br>`&none` | X<br>`&none` | C<br>`&none` | V<br>`&none` | B<br>`&none` | (center L)<br>`&none` | (center R)<br>`&none` | N<br>`&none` | M<br>`&mkp MB4` | COMMA<br>`&none` | PERIOD<br>`&mkp MB5` | SLASH<br>`&none` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 未対応: &mkp MB4 | 何もしない | 未対応: &mkp MB5 | 何もしない | 何もしない |
| ダブルタップ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 未対応: &mkp MB4 | 何もしない | 未対応: &mkp MB5 | 何もしない | 何もしない |
| Shift+ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 未対応: &mkp MB4 | 何もしない | 未対応: &mkp MB5 | 何もしない | 何もしない |
| Ctrl+ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 未対応: &mkp MB4 | 何もしない | 未対応: &mkp MB5 | 何もしない | 何もしない |
...
| 操作 | (outer)<br>`&none` | Q<br>`&kp F1` | W<br>`&kp F2` | E<br>`&kp F3` | R<br>`&kp F4` | T<br>`&kp F5` | Y<br>`&kp F6` | U<br>`&kp F7` | I<br>`&kp F8` | O<br>`&kp F9` | P<br>`&kp F10` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | F1 入力 | F2 入力 | F3 入力 | F4 入力 | F5 入力 | F6 入力 | F7 入力 | F8 入力 | F9 入力 | F10 入力 | 何もしない |
| ダブルタップ | 何もしない | F1 入力 × 2 | F2 入力 × 2 | F3 入力 × 2 | F4 入力 × 2 | F5 入力 × 2 | F6 入力 × 2 | F7 入力 × 2 | F8 入力 × 2 | F9 入力 × 2 | F10 入力 × 2 | 何もしない |
| Shift+ | 何もしない | Shift + F1（OS で合成） | Shift + F2（OS で合成） | Shift + F3（OS で合成） | Shift + F4（OS で合成） | Shift + F5（OS で合成） | Shift + F6（OS で合成） | Shift + F7（OS で合成） | Shift + F8（OS で合成） | Shift + F9（OS で合成） | Shift + F10（OS で合成） | 何もしない |
| Ctrl+ | 何もしない | Ctrl + F1（OS で合成） | Ctrl + F2（OS で合成） | Ctrl + F3（OS で合成） | Ctrl + F4（OS で合成） | Ctrl + F5（OS で合成） | Ctrl + F6（OS で合成） | Ctrl + F7（OS で合成） | Ctrl + F8（OS で合成） | Ctrl + F9（OS で合成） | Ctrl + F10（OS で合成） | 何もしない |

#### Row 2 (home row)

| 操作 | (outer)<br>`&none` | A<br>`&none` | S<br>`&sys_reset` | D<br>`&none` | F<br>`&none` | G<br>`&none` | (center L)<br>`&none` | (center R)<br>`&none` | H<br>`&none` | J<br>`&none` | K<br>`&none` | L<br>`&sys_reset` | MINUS<br>`&none` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | 何もしない | 未対応: &sys_reset | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 未対応: &sys_reset | 何もしない | 何もしない |
| ダブルタップ | 何もしない | 何もしない | 未対応: &sys_reset | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 未対応: &sys_reset | 何もしない | 何もしない |
| Shift+ | 何もしない | 何もしない | 未対応: &sys_reset | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 未対応: &sys_reset | 何もしない | 何もしない |
| Ctrl+ | 何もしない | 何もしない | 未対応: &sys_reset | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 未対応: &sys_reset | 何もしない | 何もしない |

#### Row 3 (Z row)

| 操作 | (outer)<br>`&none` | Z<br>`&none` | X<br>`&none` | C<br>`&none` | V<br>`&none` | B<br>`&bootloader` | (center L)<br>`&none` | (center R)<br>`&none` | N<br>`&bootloader` | M<br>`&none` | COMMA<br>`&none` | PERIOD<br>`&none` | SLASH<br>`&none` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 未対応: &bootloader | 何もしない | 何もしない | 未対応: &bootloader | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない |
| ダブルタップ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 未対応: &bootloader | 何もしない | 何もしない | 未対応: &bootloader | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない |
| Shift+ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 未対応: &bootloader | 何もしない | 何もしない | 未対応: &bootloader | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない |
| Ctrl+ | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 未対応: &bootloader | 何もしない | 何もしない | 未対応: &bootloader | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない |
...
| 操作 | (outer)<br>`&none` | Q<br>`&bt BT_SEL 0` | W<br>`&bt BT_SEL 1` | E<br>`&bt BT_SEL 2` | R<br>`&bt BT_SEL 3` | T<br>`&bt BT_SEL 4` | Y<br>`&none` | U<br>`&out OUT_USB` | I<br>`&none` | O<br>`&none` | P<br>`&none` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | 未対応: &bt BT_SEL 0 | 未対応: &bt BT_SEL 1 | 未対応: &bt BT_SEL 2 | 未対応: &bt BT_SEL 3 | 未対応: &bt BT_SEL 4 | 何もしない | 未対応: &out OUT_USB | 何もしない | 何もしない | 何もしない | 何もしない |
| ダブルタップ | 何もしない | 未対応: &bt BT_SEL 0 | 未対応: &bt BT_SEL 1 | 未対応: &bt BT_SEL 2 | 未対応: &bt BT_SEL 3 | 未対応: &bt BT_SEL 4 | 何もしない | 未対応: &out OUT_USB | 何もしない | 何もしない | 何もしない | 何もしない |
| Shift+ | 何もしない | 未対応: &bt BT_SEL 0 | 未対応: &bt BT_SEL 1 | 未対応: &bt BT_SEL 2 | 未対応: &bt BT_SEL 3 | 未対応: &bt BT_SEL 4 | 何もしない | 未対応: &out OUT_USB | 何もしない | 何もしない | 何もしない | 何もしない |
| Ctrl+ | 何もしない | 未対応: &bt BT_SEL 0 | 未対応: &bt BT_SEL 1 | 未対応: &bt BT_SEL 2 | 未対応: &bt BT_SEL 3 | 未対応: &bt BT_SEL 4 | 何もしない | 未対応: &out OUT_USB | 何もしない | 何もしない | 何もしない | 何もしない |

#### Row 2 (home row)

| 操作 | (outer)<br>`&none` | A<br>`&bt BT_CLR_ALL` | S<br>`&none` | D<br>`&none` | F<br>`&none` | G<br>`&none` | (center L)<br>`&none` | (center R)<br>`&none` | H<br>`&none` | J<br>`&none` | K<br>`&none` | L<br>`&none` | MINUS<br>`&none` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | 未対応: &bt BT_CLR_ALL | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない |
| ダブルタップ | 何もしない | 未対応: &bt BT_CLR_ALL | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない |
| Shift+ | 何もしない | 未対応: &bt BT_CLR_ALL | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない |
| Ctrl+ | 何もしない | 未対応: &bt BT_CLR_ALL | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない |

#### Row 3 (Z row)

| 操作 | (outer)<br>`&none` | Z<br>`&none` | X<br>`&none` | C<br>`&bt BT_CLR` | V<br>`&none` | B<br>`&out OUT_BLE` | (center L)<br>`&none` | (center R)<br>`&none` | N<br>`&none` | M<br>`&none` | COMMA<br>`&none` | PERIOD<br>`&none` | SLASH<br>`&none` | (outer)<br>`&none` |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | 何もしない | 何もしない | 未対応: &bt BT_CLR | 何もしない | 未対応: &out OUT_BLE | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない |
| ダブルタップ | 何もしない | 何もしない | 何もしない | 未対応: &bt BT_CLR | 何もしない | 未対応: &out OUT_BLE | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない |
| Shift+ | 何もしない | 何もしない | 何もしない | 未対応: &bt BT_CLR | 何もしない | 未対応: &out OUT_BLE | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない |
| Ctrl+ | 何もしない | 何もしない | 何もしない | 未対応: &bt BT_CLR | 何もしない | 未対応: &out OUT_BLE | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない |
