...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | フォールスルー | 何もしない | フォールスルー | 何もしない | フォールスルー | 何もしない | PAGE_UP 入力 | フォールスルー | 何もしない | HOME 入力 | 何もしない |
| ダブルタップ | 何もしない | フォールスルー | 何もしない | フォールスルー | 何もしない | フォールスルー | 何もしない | PAGE_UP 入力 × 2 | フォールスルー | 何もしない | HOME 入力 × 2 | 何もしない |
| Shift+ | 何もしない | フォールスルー | 何もしない | フォールスルー | END 入力 | フォールスルー | HOME 入力 | Shift + PAGE_UP（OS で合成） | フォールスルー | 何もしない | Shift + HOME（OS で合成） | 何もしない |
| Ctrl+ | 何もしない | フォールスルー | 何もしない | フォールスルー | 何もしない | フォールスルー | 何もしない | Ctrl + PAGE_UP（OS で合成） | フォールスルー | 何もしない | Ctrl + HOME（OS で合成） | 何もしない |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | Left Ctrl 入力 | フォールスルー | PAGE_DOWN 入力 | フォールスルー | 何もしない | 何もしない | 何もしない | フォールスルー | フォールスルー | フォールスルー | フォールスルー | Right Ctrl 入力 | 何もしない |
| ダブルタップ | 何もしない | Left Ctrl 入力 × 2 | フォールスルー | PAGE_DOWN 入力 × 2 | フォールスルー | 何もしない | 何もしない | 何もしない | フォールスルー | フォールスルー | フォールスルー | フォールスルー | Right Ctrl 入力 × 2 | 何もしない |
| Shift+ | 何もしない | Shift + Left Ctrl（OS で合成） | フォールスルー | Shift + PAGE_DOWN（OS で合成） | フォールスルー | 何もしない | 何もしない | 何もしない | フォールスルー | フォールスルー | フォールスルー | フォールスルー | Shift + Right Ctrl（OS で合成） | 何もしない |
| Ctrl+ | 何もしない | Ctrl + Left Ctrl（OS で合成） | フォールスルー | Ctrl + PAGE_DOWN（OS で合成） | フォールスルー | 何もしない | 何もしない | 何もしない | フォールスルー | フォールスルー | フォールスルー | フォールスルー | Ctrl + Right Ctrl（OS で合成） | 何もしない |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | Left Shift 入力 | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | フォールスルー | フォールスルー | フォールスルー | フォールスルー | Right Shift 入力 | 何もしない |
| ダブルタップ | 何もしない | Left Shift 入力 × 2 | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | フォールスルー | フォールスルー | フォールスルー | フォールスルー | Right Shift 入力 × 2 | 何もしない |
| Shift+ | 何もしない | Shift + Left Shift（OS で合成） | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | フォールスルー | フォールスルー | フォールスルー | フォールスルー | Shift + Right Shift（OS で合成） | 何もしない |
| Ctrl+ | 何もしない | Ctrl + Left Shift（OS で合成） | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | フォールスルー | フォールスルー | フォールスルー | フォールスルー | Ctrl + Right Shift（OS で合成） | 何もしない |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 単発タップ | 何もしない | 何もしない | フォールスルー | フォールスルー | フォールスルー | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | フォールスルー | 何もしない | 何もしない |
| ダブルタップ | 何もしない | 何もしない | フォールスルー | フォールスルー | フォールスルー | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | フォールスルー | 何もしない | 何もしない |
| Shift+ | 何もしない | 何もしない | フォールスルー | フォールスルー | フォールスルー | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | フォールスルー | 何もしない | 何もしない |
| Ctrl+ | 何もしない | 何もしない | フォールスルー | フォールスルー | フォールスルー | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | 何もしない | フォールスルー | 何もしない | 何もしない |
