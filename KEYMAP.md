...
| ホールド |  | Q 押下保持 | W 押下保持 | E 押下保持 | R 押下保持 | T 押下保持 | Y 押下保持 | U 押下保持 | I 押下保持 | O 押下保持 | P 押下保持 |  |  |  |
...
| ホールド |  | Left Ctrl 修飾子保持 | S 押下保持 | D 押下保持 | F 押下保持 | G 押下保持 |  |  | H 押下保持 | J 押下保持 | K 押下保持 | L 押下保持 | Right Ctrl 修飾子保持 |  |
...
| ホールド |  | Left Shift 修飾子保持 | X 押下保持 | C 押下保持 | V 押下保持 | B 押下保持 | レイヤー 7 を momentary（押下中のみ）有効化 | レイヤー 7 を momentary（押下中のみ）有効化 | N 押下保持 | M 押下保持 | COMMA 押下保持 | PERIOD 押下保持 | Right Shift 修飾子保持 |  |
...
| ホールド |  | レイヤー 6 を momentary（押下中のみ）有効化 | Left Win 押下保持 | Left Alt 押下保持 | レイヤー 2 を momentary 有効化 | レイヤー 2 を momentary 有効化 | レイヤー 1 を momentary（押下中のみ）有効化 | レイヤー 2 を momentary（押下中のみ）有効化 | レイヤー 1 を momentary 有効化 |  |  | レイヤー 6 を momentary（押下中のみ）有効化 | レイヤー 6 を momentary（押下中のみ）有効化 |  |
...
| ホールド |  | N1 押下保持 | N2 押下保持 | N3 押下保持 | N4 押下保持 | N5 押下保持 | N6 押下保持 | N7 押下保持 | N8 押下保持 | N9 押下保持 | N0 押下保持 |  |  |  |
...
| ホールド |  | Left Ctrl 修飾子保持 | GRAVE 押下保持 | LEFT_BRACKET 押下保持 | RIGHT_BRACKET 押下保持 | DELETE 押下保持 |  |  | BACKSPACE 押下保持 | SEMICOLON 押下保持 | SINGLE_QUOTE 押下保持 | BACKSLASH 押下保持 | ▽ |  |
...
| ホールド |  | Left Shift 修飾子保持 |  |  |  |  |  |  |  | EQUAL 押下保持 | ▽ | ▽ | ▽ |  |
...
| ホールド |  |  | ▽ | ▽ | レイヤー 3 を momentary 有効化 | レイヤー 3 を momentary 有効化 |  | レイヤー 3 を momentary（押下中のみ）有効化 |  |  |  | ▽ |  |  |
...
| ホールド |  | ESC 押下保持 | Ctrl+→ 押下保持 | Ctrl+→ 押下保持 |  |  | Ctrl+C 押下保持 | Ctrl+Z 押下保持 |  | END → ENTER（押下時に 1 回実行） | Ctrl+V 押下保持 |  |  |  |
...
| ホールド |  | Left Ctrl 押下保持 |  |  |  |  |  |  | ← 押下保持 | ↓ 押下保持 | ↑ 押下保持 | → 押下保持 | Right Ctrl 押下保持 |  |
...
| ホールド |  | Left Shift 押下保持 | DELETE 押下保持 |  | レイヤー 8 に切替 | Ctrl+← 押下保持 |  |  | F3 押下保持 |  |  |  | Right Shift 押下保持 |  |
...
| ホールド |  |  | ▽ | ▽ |  |  | レイヤー 3 を momentary（押下中のみ）有効化 |  | レイヤー 3 を momentary 有効化 |  |  | ▽ |  |  |
...
| ホールド |  | Left Ctrl 押下保持 |  |  |  |  |  |  | ← 押下保持 |  |  |  | Right Ctrl 押下保持 |  |
...
| ホールド |  | Left Shift 押下保持 |  |  |  |  |  |  |  |  |  |  | Right Shift 押下保持 |  |
...
| ホールド |  |  |  |  |  |  |  |  |  |  | レイヤー 5 を momentary（押下中のみ）有効化 |  |  |  |
...
| ホールド |  | F1 押下保持 | F2 押下保持 | F3 押下保持 | F4 押下保持 | F5 押下保持 | F6 押下保持 | F7 押下保持 | F8 押下保持 | F9 押下保持 | F10 押下保持 |  |  |  |
...
| ホールド |  | Left Shift → RSHIFT &kp RIGHT → レイヤー 0 へ（押下時に 1 回実行） | Shift+Ctrl+→ 押下保持 | Shift+Ctrl+→ 押下保持 |  |  |  |  |  |  | Left Shift → RSHIFT &kp LC(V) → レイヤー 0 へ（押下時に 1 回実行） |  |  |  |
...
| ホールド |  | Left Ctrl 押下保持 |  | Left Shift → RSHIFT &kp LC(X) → レイヤー 0 へ（押下時に 1 回実行） |  |  |  |  | Shift+← 押下保持 | Shift+↓ 押下保持 | Shift+UP 押下保持 | Shift+→ 押下保持 | Right Ctrl 押下保持 |  |
...
| ホールド |  | Left Shift 押下保持 | Left Shift → RSHIFT &kp LC(X) → レイヤー 0 へ（押下時に 1 回実行） |  | Left Shift → RSHIFT &kp RIGHT → レイヤー 0 へ（押下時に 1 回実行） | Shift+Ctrl+← 押下保持 |  |  | F3 押下保持 |  |  |  | Right Shift 押下保持 |  |
...
| ホールド | &none | &none | &none | &none | &none | &none | &none | &none | &none | &none | &none | &none |  |  |
...
| ホールド | &none | &kp Q（押下保持で OS の auto-repeat / 修飾子状態） | &kp W（押下保持で OS の auto-repeat / 修飾子状態） | &kp E（押下保持で OS の auto-repeat / 修飾子状態） | &kp R（押下保持で OS の auto-repeat / 修飾子状態） | &kp T（押下保持で OS の auto-repeat / 修飾子状態） | &kp Y（押下保持で OS の auto-repeat / 修飾子状態） | &kp U（押下保持で OS の auto-repeat / 修飾子状態） | &kp I（押下保持で OS の auto-repeat / 修飾子状態） | &kp O（押下保持で OS の auto-repeat / 修飾子状態） | &kp P（押下保持で OS の auto-repeat / 修飾子状態） | &none |  |  |
...
| ホールド | &none | &mt LEFT_CONTROL A（ホールドで修飾子） | &kp S（押下保持で OS の auto-repeat / 修飾子状態） | &kp D（押下保持で OS の auto-repeat / 修飾子状態） | &kp F（押下保持で OS の auto-repeat / 修飾子状態） | &kp G（押下保持で OS の auto-repeat / 修飾子状態） | &none | &none | &kp H（押下保持で OS の auto-repeat / 修飾子状態） | &kp J（押下保持で OS の auto-repeat / 修飾子状態） | &kp K（押下保持で OS の auto-repeat / 修飾子状態） | &kp L（押下保持で OS の auto-repeat / 修飾子状態） | &mt RCTRL MINUS（ホールドで修飾子） | &none |
...
| ホールド | &none | &mt LEFT_SHIFT Z（ホールドで修飾子） | &kp X（押下保持で OS の auto-repeat / 修飾子状態） | &kp C（押下保持で OS の auto-repeat / 修飾子状態） | &kp V（押下保持で OS の auto-repeat / 修飾子状態） | &kp B（押下保持で OS の auto-repeat / 修飾子状態） | &mo 7 | &mo 7 | &kp N（押下保持で OS の auto-repeat / 修飾子状態） | &kp M（押下保持で OS の auto-repeat / 修飾子状態） | &kp COMMA（押下保持で OS の auto-repeat / 修飾子状態） | &kp PERIOD（押下保持で OS の auto-repeat / 修飾子状態） | &mt RIGHT_SHIFT SLASH（ホールドで修飾子） | &none |
...
| ホールド | &none | &mo 6 | &kp LEFT_WIN（押下保持で OS の auto-repeat / 修飾子状態） | &kp LEFT_ALT（押下保持で OS の auto-repeat / 修飾子状態） | &lt 2 SPACE（ホールドでレイヤー切替） | &lt 2 SPACE（ホールドでレイヤー切替） | &mo 1 | &mo 2 | &lt 1 ENTER（ホールドでレイヤー切替） | &none | &none | &mo 6 | &mo 6 | &none |
...
| ホールド | &none | &kp N1（押下保持で OS の auto-repeat / 修飾子状態） | &kp N2（押下保持で OS の auto-repeat / 修飾子状態） | &kp N3（押下保持で OS の auto-repeat / 修飾子状態） | &kp N4（押下保持で OS の auto-repeat / 修飾子状態） | &kp N5（押下保持で OS の auto-repeat / 修飾子状態） | &kp N6（押下保持で OS の auto-repeat / 修飾子状態） | &kp N7（押下保持で OS の auto-repeat / 修飾子状態） | &kp N8（押下保持で OS の auto-repeat / 修飾子状態） | &kp N9（押下保持で OS の auto-repeat / 修飾子状態） | &kp N0（押下保持で OS の auto-repeat / 修飾子状態） | &none |  |  |
...
| ホールド | &none | &mt LCTRL TAB（ホールドで修飾子） | &kp GRAVE（押下保持で OS の auto-repeat / 修飾子状態） | &kp LEFT_BRACKET（押下保持で OS の auto-repeat / 修飾子状態） | &kp RIGHT_BRACKET（押下保持で OS の auto-repeat / 修飾子状態） | &kp DELETE（押下保持で OS の auto-repeat / 修飾子状態） | &none | &none | &kp BACKSPACE（押下保持で OS の auto-repeat / 修飾子状態） | &kp SEMICOLON（押下保持で OS の auto-repeat / 修飾子状態） | &kp SINGLE_QUOTE（押下保持で OS の auto-repeat / 修飾子状態） | &kp BACKSLASH（押下保持で OS の auto-repeat / 修飾子状態） | &trans | &none |
...
| ホールド | &none | &mt LEFT_SHIFT ESCAPE（ホールドで修飾子） | &none | &none | &none | &none | &none | &none | &none | &kp EQUAL（押下保持で OS の auto-repeat / 修飾子状態） | &trans | &trans | &trans | &none |
...
| ホールド | &none | &none | &trans | &trans | &lt 3 SPACE（ホールドでレイヤー切替） | &lt 3 SPACE（ホールドでレイヤー切替） | &none | &mo 3 | &none | &none | &none | &trans | &none | &none |
...
| ホールド | &none | mm_vim_q[0] → &kp ESCAPE（押下保持で OS の auto-repeat / 修飾子状態） | mm_vim_w[0] → &kp LC(RIGHT)（押下保持で OS の auto-repeat / 修飾子状態） | &kp LC(RIGHT)（押下保持で OS の auto-repeat / 修飾子状態） | mm_vim_ctrl_r[0] → &none | &none | mm_vim_shift_y[0] → td_vim_y[0] (tap-dance は hold を [0] に委譲) → &kp LC(C)（押下保持で OS の auto-repeat / 修飾子状態） | mm_vim_ctrl_u[0] → &kp LC(Z)（押下保持で OS の auto-repeat / 修飾子状態） | &none | mm_vim_shift_o[0] → macro_vim_o | &kp LC(V)（押下保持で OS の auto-repeat / 修飾子状態） | &none |  |  |
...
| ホールド | &none | &kp LCTRL（押下保持で OS の auto-repeat / 修飾子状態） | &none | mm_vim_ctrl_then_shift_d[0] → mm_vim_shift_d[0] → td_vim_d[0] (tap-dance は hold を [0] に委譲) → &none | &none | mm_vim_g[0] → td_vim_g[0] (tap-dance は hold を [0] に委譲) → &none | &none | &none | &kp LEFT（押下保持で OS の auto-repeat / 修飾子状態） | mm_vim_j[0] → &kp DOWN（押下保持で OS の auto-repeat / 修飾子状態） | &kp UP_ARROW（押下保持で OS の auto-repeat / 修飾子状態） | &kp RIGHT（押下保持で OS の auto-repeat / 修飾子状態） | &kp RCTRL（押下保持で OS の auto-repeat / 修飾子状態） | &none |
...
| ホールド | &none | &kp LEFT_SHIFT（押下保持で OS の auto-repeat / 修飾子状態） | &kp DELETE（押下保持で OS の auto-repeat / 修飾子状態） | &none | mm_vim_v[0] → &to 8 | &kp LC(LEFT)（押下保持で OS の auto-repeat / 修飾子状態） | &none | &none | mm_vim_n[0] → &kp F3（押下保持で OS の auto-repeat / 修飾子状態） | &none | &none | &none | &kp RIGHT_SHIFT（押下保持で OS の auto-repeat / 修飾子状態） | &none |
...
| ホールド | &none | &none | &trans | &trans | &none | &none | &mo 3 | &none | &lt 3 ENTER（ホールドでレイヤー切替） | &none | &none | &trans | &none | &none |
...
| ホールド | &none | &none | &none | &none | mm_vim_shift_4[0] → &none | &none | mm_vim_shift_6[0] → &none | &none | &none | &none | &kp HOME（押下保持で OS の auto-repeat / 修飾子状態） | &none |  |  |
...
| ホールド | &none | &kp LCTRL（押下保持で OS の auto-repeat / 修飾子状態） | &none | &none | &none | &none | &none | &none | &kp LEFT（押下保持で OS の auto-repeat / 修飾子状態） | &none | &none | &none | &kp RCTRL（押下保持で OS の auto-repeat / 修飾子状態） | &none |
...
| ホールド | &none | &kp LEFT_SHIFT（押下保持で OS の auto-repeat / 修飾子状態） | &none | &none | &none | &none | &none | &none | &none | &none | &none | &none | &kp RIGHT_SHIFT（押下保持で OS の auto-repeat / 修飾子状態） | &none |
...
| ホールド | &none | &none | &trans | &trans | &none | &none | &none | &none | &none | &none | &none | &trans | &none | &none |
...
| ホールド | &none | &none | &none | &none | &none | &none | &none | &none | &none | &none | &mo 5 | &none | &none | &none |
...
| ホールド | &none | &none | &none | &none | &none | &none | &none | &none | &none | &none | &none | &none | &none | &none |
...
| ホールド | &none | &none | &none | &none | &none | &none | &none | &none | &none | &mkp MB1 | &none | &mkp MB2 | &none | &none |
...
| ホールド | &none | &none | &none | &none | &none | &none | &none | &none | &none | &mkp MB4 | &none | &mkp MB5 | &none | &none |
...
| ホールド | &none | &kp F1（押下保持で OS の auto-repeat / 修飾子状態） | &kp F2（押下保持で OS の auto-repeat / 修飾子状態） | &kp F3（押下保持で OS の auto-repeat / 修飾子状態） | &kp F4（押下保持で OS の auto-repeat / 修飾子状態） | &kp F5（押下保持で OS の auto-repeat / 修飾子状態） | &kp F6（押下保持で OS の auto-repeat / 修飾子状態） | &kp F7（押下保持で OS の auto-repeat / 修飾子状態） | &kp F8（押下保持で OS の auto-repeat / 修飾子状態） | &kp F9（押下保持で OS の auto-repeat / 修飾子状態） | &kp F10（押下保持で OS の auto-repeat / 修飾子状態） | &none |  |  |
...
| ホールド | &none | &none | &sys_reset | &none | &none | &none | &none | &none | &none | &none | &none | &sys_reset | &none | &none |
...
| ホールド | &none | &none | &none | &none | &none | &bootloader | &none | &none | &bootloader | &none | &none | &none | &none | &none |
...
| ホールド | &none | &bt BT_SEL 0 | &bt BT_SEL 1 | &bt BT_SEL 2 | &bt BT_SEL 3 | &bt BT_SEL 4 | &none | &out OUT_USB | &none | &none | &none | &none |  |  |
...
| ホールド | &none | &bt BT_CLR_ALL | &none | &none | &none | &none | &none | &none | &none | &none | &none | &none | &none | &none |
...
| ホールド | &none | &none | &none | &bt BT_CLR | &none | &out OUT_BLE | &none | &none | &none | &none | &none | &none | &none | &none |
...
| ホールド | &none | macro_vim_visual_exit | &kp LS(LC(RIGHT))（押下保持で OS の auto-repeat / 修飾子状態） | &kp LS(LC(RIGHT))（押下保持で OS の auto-repeat / 修飾子状態） | &none | &none | &none | &none | &none | &none | macro_vim_visual_p | &none |  |  |
...
| ホールド | &none | &kp LCTRL（押下保持で OS の auto-repeat / 修飾子状態） | &none | macro_vim_visual_cut | &none | mm_vim_visual_g[0] → td_vim_visual_g[0] (tap-dance は hold を [0] に委譲) → &none | &none | &none | &kp LS(LEFT)（押下保持で OS の auto-repeat / 修飾子状態） | &kp LS(DOWN)（押下保持で OS の auto-repeat / 修飾子状態） | &kp LS(UP)（押下保持で OS の auto-repeat / 修飾子状態） | &kp LS(RIGHT)（押下保持で OS の auto-repeat / 修飾子状態） | &kp RCTRL（押下保持で OS の auto-repeat / 修飾子状態） | &none |
...
| ホールド | &none | &kp LEFT_SHIFT（押下保持で OS の auto-repeat / 修飾子状態） | macro_vim_visual_cut | &none | macro_vim_visual_exit | &kp LS(LC(LEFT))（押下保持で OS の auto-repeat / 修飾子状態） | &none | &none | &kp F3（押下保持で OS の auto-repeat / 修飾子状態） | &none | &none | &none | &kp RIGHT_SHIFT（押下保持で OS の auto-repeat / 修飾子状態） | &none |
